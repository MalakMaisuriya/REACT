      ...
      <div className="row justify-content-center">
        ...
        <div className="col-lg-3 d-none d-lg-block border-end border-secondary bg-black">
          <div className="p-4">
            ...
            <a href="https://www.instagram.com/malak_maisuriya_/" target="_blank" className="text-white text-decoration-none d-block mb-3">
            ...
            <a href="https://www.instagram.com/malak_maisuriya_/" target="_blank" className="text-white text-decoration-none d-block">
          ...
          <div className="card shadow border-secondary bg-dark text-white">
            <div className="card-header bg-dark border-secondary d-flex justify-content-between align-items-center">
              <div className="d-flex align-items-center">
                ...
                <strong>malak_maisuriya_</strong>
              </div>
